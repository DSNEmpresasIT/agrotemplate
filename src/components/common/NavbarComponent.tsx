...
const NavbarComponent = () => {
  ...
  return (
    <nav className={`bg-black/20 w-full fixed top-0 z-[9999] sm:bg-none font-normal headerScroll text-white font-['Kumbh Sans'] text-base
      ...
      <div className="max-w-wrapper flex flex-wrap items-center justify-end mx-auto min-h-[73px] px-4">
        ...
        >
          ...
          <div className="relative w-6 h-6 flex justify-center items-center">
            <span
              className={`absolute w-full h-[2px] bg-white rounded transition-all duration-300 ease-in-out ${isOpen ? "rotate-45 translate-y-0" : "-translate-y-2"
                }`}
            ></span>
            <span
              className={`absolute w-full h-[2px] bg-white rounded transition-all duration-300 ease-in-out ${isOpen ? "opacity-0" : "opacity-100"
                }`}
            ></span>
            <span
              className={`absolute w-full h-[2px] bg-white rounded transition-all duration-300 ease-in-out ${isOpen ? "-rotate-45 translate-y-0" : "translate-y-2"
            ...
            <ul className="font-medium md:items-center flex flex-col bg-black/80 md:bg-transparent p-4 md:p-0 mt-4 border-b border-gray-100 rounded-b-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
              <li>
                <Link
                  ...
                  href={`/`}
                  className={`block py-2 px-3  md:p-0 ${isActive('/') ? 'border-b border-solid border-white/50 text-white' : 'hover:bg-gray-100 hover:text-light border-transparent border-b hover:border-white/50  md:hover:bg-transparent md:hover:text-light'
                    }`}
                >
                  Inicio
                </Link>
              ...
              <li className="relative group">
                ...
                <div
                  className={`${!isDeptOpen || 'peer-hover:flex '
              ...
              <li>
                <Link
                  ...
                  className={`block py-2 px-3 rounded md:p-0 ${isActive(CUSTOMPATHS.GALLERY) ? 'border-b-2 border-white/50 text-white' : 'border-transparent border-b hover:border-white/50 hover:bg-gray-100 hover:text-light md:hover:bg-transparent md:hover:text-light'
                    }`}
                >
                  Galería
                </Link>
              ...
              <li>
                <Link
                  ...
                  className={`block py-2 px-3 rounded md:p-0 ${isActive(`${CUSTOMPATHS.CONTACT}`) ? 'border-b-2 border-white/50 text-white' : 'border-transparent border-b hover:border-white/50 hover:bg-gray-100 hover:text-light md:hover:bg-transparent md:hover:text-light'
                    }`}
                >
                  Sobre nosotros
                </Link>
